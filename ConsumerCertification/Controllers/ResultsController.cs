    ...
    public class ResultsController : ResultsControllerBase
    {
        ...
        public ResultsController()
        {
            ...
            OnPostResult = context =>
            {
                ...
                // Normally Result.Id would be calculated based on an id assigned by the database
                context.Result.Id = RoutingHelper.GetResultsUri(new HttpContextWrapper(HttpContext.Current), context.ContextId, context.LineItemId, ResultId);
